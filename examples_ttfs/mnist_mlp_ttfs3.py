...
class Net(torch.nn.Module):
    def __init__(self, T):
        ...
        b = [5, 24, 48]  # The upper bound of wight initializations for hidden and ouput neurons
        ...
        self.fc2 = ttfsCat.Dense(400, 200, T=T, theta=thr[1])
        self.fc3 = ttfsCat.Dense(200, 10, T=T, theta=thr[2])
        ...
        torch.nn.init.uniform_(self.fc3.weight, a=a[2], b=b[2])
...
def main():
    ...
    try:
        for epoch in range(1, args.epochs + 1):
            ...
            scheduler.step()
            if args.save_model:
                torch.save(model.state_dict(), "mnist_mlp_ttfs3.pt")
        if args.save_model:
            torch.save(model.state_dict(), "mnist_mlp_ttfs3_final.pt")
    except KeyboardInterrupt:
        torch.save(model.state_dict(), "mnist_mlp_ttfs3_int.pt")
        print("Model Saved at mnist_mlp_ttfs3_int.pt")
