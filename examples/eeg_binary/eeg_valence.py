...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(64, 64, 5, 1,0,bias=True)
        self.Bn2 = nn.BatchNorm2d(64)
        self.conv3 = nn.Conv2d(64, 128, 5, 1, 0,bias=True)
        ...
        self.fc1 = nn.Linear(128* 4*4,128, bias=True)
...
class CatNet(nn.Module):
    ...
    def __init__(self, T):
        ...
        self.conv2 = snn.conv(64, 64, 5, 1,0, bias=True)
        self.conv3 = snn.conv(64, 128,5,1,0, bias=True)
        self.pool1 = snn.pool(2)
        self.pool2 = snn.pool(2)
        self.fc1 = snn.dense((4,4,128), 128, bias=True)
...
def main():
    ...
    parser.add_argument('--T', type=int, default=160, metavar='N',
    ...
    train_loader = torch.utils.data.DataLoader(torch_dataset_train,shuffle=True,batch_size=512)
